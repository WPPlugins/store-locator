...
* [Custom Field Manager](http://docs.viadat.com/Custom_Field_Manager) - update: prelim prep
* v3.98.1 - Bug fix helping [Categorizer](http://docs.viadat.com/Categorizer) fully display & operate its filters
